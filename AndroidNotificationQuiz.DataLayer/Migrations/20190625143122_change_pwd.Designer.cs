...
namespace AndroidNotificationQuiz.DataLayer.Migrations
{
    ...
    [Migration("20190625143122_change_pwd")]
            ...
            modelBuilder.Entity("AndroidNotificationQuiz.DomainLayer.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2019, 6, 25, 14, 31, 21, 808, DateTimeKind.Unspecified).AddTicks(4620), new TimeSpan(0, 0, 0, 0, 0)),
