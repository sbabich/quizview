...
namespace AndroidNotificationQuiz.DataLayer.Migrations
{
    ...
    [Migration("20190616210755_add_field_to_user_transaction")]
    partial class add_field_to_user_transaction
    {
            ...
            modelBuilder.Entity("AndroidNotificationQuiz.DomainLayer.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2019, 6, 16, 21, 7, 54, 850, DateTimeKind.Unspecified).AddTicks(1090), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "admin@admin.com",
                            PwdSalt = "u96IsV97bAhrjz0yWKkLcjkMHMEZUB1HDsjZlN/JZWc="
                        });
                });
