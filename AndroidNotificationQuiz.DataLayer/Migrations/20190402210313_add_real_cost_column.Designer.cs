...
namespace AndroidNotificationQuiz.DataLayer.Migrations
{
    ...
    [Migration("20190402210313_add_real_cost_column")]
    partial class add_real_cost_column
    {
            ...
            modelBuilder.Entity("AndroidNotificationQuiz.DomainLayer.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2019, 4, 2, 21, 3, 13, 277, DateTimeKind.Unspecified).AddTicks(9410), new TimeSpan(0, 0, 0, 0, 0)),
