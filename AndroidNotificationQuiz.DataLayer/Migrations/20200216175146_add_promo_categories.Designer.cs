...
namespace AndroidNotificationQuiz.DataLayer.Migrations
{
    ...
    [Migration("20200216175146_add_promo_categories")]
    partial class add_promo_categories
    {
            ...
            modelBuilder.Entity("AndroidNotificationQuiz.DomainLayer.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2020, 2, 16, 17, 51, 46, 496, DateTimeKind.Unspecified).AddTicks(1757), new TimeSpan(0, 0, 0, 0, 0)),
