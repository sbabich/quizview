...
namespace AndroidNotificationQuiz.DataLayer.Migrations
{
    ...
    [Migration("20190527133024_add_field_to_order")]
    partial class add_field_to_order
    {
            ...
            modelBuilder.Entity("AndroidNotificationQuiz.DomainLayer.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2019, 5, 27, 13, 30, 24, 586, DateTimeKind.Unspecified).AddTicks(5190), new TimeSpan(0, 0, 0, 0, 0)),
